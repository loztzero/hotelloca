...
<div class="row" ng-controller="MainCtrl">
	<a href="{{ url('hotel-admin/hotel-browse') }}" class="button tiny secondary">Back</a>
	<h3>Input New Hotel</h3>

	@include('layouts.message-helper')
	<div class="large-12 colums">
		<form class="form-horizontal" role="form" method="POST" action="{{ url('hotel-admin/save-hotel-input') }}" data-abide>
		    ...
		    <div class="row">
				<div class="panel">
					...
					<div class="row">
				        ...
				        <div class="small-12 medium-9 large-4 columns left">
				          <input type="password" class="span2" id="passwordLogin" name="password" required>
					...
					<div class="row">
				        ...
				        <div class="small-12 medium-9 large-4 columns left">
				          <input type="password" class="span2" id="rePasswordLogin" name="repassword" required>
