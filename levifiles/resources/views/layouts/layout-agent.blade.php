          ...
          <nav class="top-bar hide-for-small" data-topbar role="navigation">
            <div style="width:1028px;margin:0 auto;">
              ...
              <section class="top-bar-section" style="max-width:1024px;margin:0 auto;margin-top:30px;">
                <!-- Right Nav Section -->
                <ul class="right">
                  <li><a href="{{url('agent/profile')}}"><i class="fi-torso-business"></i>&nbsp; Profile Agent</a></li>
                  <li><a href="{{url('agent/hotel')}}"><i class="fi-home"></i>&nbsp; Hotel</a></li>
                  <li><a href="{{url('agent/booking')}}"><i class="fi-book"></i>&nbsp; Booking</a></li>
