                ...
                <div class="container">
                    ...
                    <nav id="main-menu" role="navigation">
                        <ul class="menu">
                            ...
                            <li class="menu-item"><a href="index.html">Company Profile</a></li>
                            <li class="menu-item"><a href="index.html">Service</a></li>
                            <li class="menu-item"><a href="index.html">Term And Condition</a></li>
