	...
	<div class="page-title-container">
	    <div class="container">
	        ...
	        <ul class="breadcrumbs pull-right">
	            ...
	            <li class="active">Hotel Pictures</li>
	        </ul>
	    </div>
	</div>
@endsection
...
<div class="container" ng-controller="MainCtrl">
	...
	<div class="travelo-box">
		<form method="post" action="{{ url('admin/hotel-vs-user/save-picture') }}" enctype="multipart/form-data">
	...
	<div class="items-container isotope image-box style9 row">
		@foreach($hotel->pictures as $picture)
		    <div class="iso-item col-xs-12 col-sms-6 col-sm-6 col-md-3">
		        <article class="box">
		            <figure>
		            	<form method="post" action="{{ url('admin/hotel-vs-user/delete-picture') }}">
							<input type="hidden" name="_token" value="{{ csrf_token() }}">
							<input type="hidden" name="id" value="{{ $picture->id }}">
							<input type="hidden" name="hotel" value="{{ $hotel->id }}">
		                	<a class="hover-effect confirm-delete" title="" href="#"><img width="270" height="160" alt="" src="{{ url('uploads/hotels/'.Request::get('hotel').'/'.$picture->pict.'.jpg') }}"></a>
						</form>
		            </figure>
		            <div class="details">
