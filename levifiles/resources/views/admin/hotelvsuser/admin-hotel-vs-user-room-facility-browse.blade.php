...
<div class="container" ng-controller="MainCtrl">
	...
	<a href="{{ url('admin/hotel-vs-user/room?hotel=') . $room->mst020_id }}" class="button tiny secondary"><< Back</a><br>
	<div class="travelo-box">

		<h3>Hotel {{ $room->room_name }} Facilities</h3>
		...
		<table class="table table-striped">
			...
			@foreach($facilities as $facility)
				<tr>
					<td>
						<form action="{{ url('admin/hotel-vs-user/delete-facility')}}" method="post" class="right">
							<input type="hidden" value="{{ csrf_token() }}" name="_token">
			            	<input type="hidden" value="{{ $facility->id }}" name="id">
			            	<input type="hidden" value="{{ Request::get('hotel') }}" name="hotel">
	...
	@include('admin.hotelvsuser.admin-hotel-vs-user-room-facility-input-dialog')
