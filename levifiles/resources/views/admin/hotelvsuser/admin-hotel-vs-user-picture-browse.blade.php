			...
			<table class="table table-striped">
				...
				<tbody>
					...
					<tr>
						...
						<td>
							<a href="{{ url('admin/hotel-vs-user/facility') . '?hotel=' . $hotel->id }}" class="button btn-small sky-blue2">Add Facilities</a>
							<a href="{{ url('admin/hotel-vs-user/room') . '?hotel=' . $hotel->id }}" class="button btn-small sky-blue2">Add Rooms</a>
						</td>
					</tr>
					@endforeach
				</tbody>
