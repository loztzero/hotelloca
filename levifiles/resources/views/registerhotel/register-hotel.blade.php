...
{{-- 	@if(Session::get('error'))
	...
	<div class="large-12 colums">
		<form class="form-horizontal" role="form" method="POST" action="{{App::make('url')->to('/')}}/auth/save" data-abide>
		    ...
		    <div class="row">
				<div class="large-2 medium-3 columns">
		          <label for="phoneNumber" class="right inline show-for-medium-up">Landmark Name *</label>
		          <label for="phoneNumber" class="show-for-small-only">Landmark Name *</label>
		        </div>
		        <div class="small-12 medium-9 large-4 columns left">
		          <input type="text" class="span2" value="{{old('phone_number')}}" id="phoneNumber" name="phone_number" required>
		          <small class="error">Landmakr name required</small>
		        </div>
		    </div>
		    ...
		    <div class="row">
				<div class="large-2 medium-3 columns">
		          <label for="website" class="right inline show-for-medium-up">Meal Price</label>
		          <label for="website" class="show-for-small-only">Meal Price</label>
		        </div>
		        <div class="small-12 medium-9 large-4 columns left">
		          <input type="text" class="span2" value="{{old('website')}}" id="website">
		        </div>
