...
class BookingController extends Controller {
	...
	public function getIndex(){
		return view('admin.booking.admin-booking');
	}
	...
	public function getHotelBrowse(Request $request){
		...
		return view('admin.booking.hotel-admin-hotel-browse')
	...
	public function getHotelInput(){
		...
		return view('admin.booking.hotel-admin-hotel-input')->with('countries', $countries)
