...
ALTER TABLE `LOG001` DROP FOREIGN KEY `TRX001_LOG001`;

ALTER TABLE `LOG001` DROP FOREIGN KEY `BLNC001_LOG001`;
...
ALTER TABLE `LOG001` DROP PRIMARY KEY;

DROP INDEX `TUC_LOG001_1` ON `LOG001`;
