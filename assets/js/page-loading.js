...
if (typeof Pace != "undefined") {
    ...
    //document.write('<img alt="" src="assets/images/logo2.png" style="display: none;">');
    var logoImg = new Image();
    logoImg.src = "http://localhost:8080/hotelloca/assets/images/logo.png";
                                                    ...
                                                    '<div class="container">' +
                                                            '<h1 class="logo block">' +
                                                                '<a title="Travelo" href="#">' +
                                                                    '<img alt="" src="http://localhost:8080/hotelloca/assets/images/logo.png">' +
                                                                '</a>' +
                                                            '</h1>' +
